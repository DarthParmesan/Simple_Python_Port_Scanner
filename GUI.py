...
class GUI:
    ...
    def init_components(self):
        ...
        # Buttons.
        start_scan = tk.Button(self.root, font=("Courier", 10), text="Start Scan", width=12, command=self.start_scan).place(x=275, y=y0+100)
        save_scan = tk.Button(self.root, font=("Courier", 10), text="Save Scan", width=12, command=self.save_scan).place(x=275, y=y0+135)
        exit_button = tk.Button(self.root, font=("Courier", 10), text="Exit", width=12, command=self.kill).place(x=275, y=y0+320)
